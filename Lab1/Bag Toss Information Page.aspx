<%@ Page Title="Jake Mitchell - Bag Toss Information Page" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="Bag Toss Information Page.aspx.cs" Inherits="Lab3.Bag_Toss_Information_Page" %>
<%--Jake Mitchell
Section 0002
10/3/2020--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:Table runat="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="pageInstructions" runat="server" Text="Current (live) list of students attending the 'Bag Toss' event: "></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
    ...
    <asp:Table runat ="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="lblVolunteerList" runat="server" Text="Current (live) list of volunteers attending the 'Bag Toss' event: "></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    ...
    <asp:Table runat ="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="lblCoordinatorList" runat="server" Text="Current (live) list of  'Bag Toss' event coordinators: "></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>

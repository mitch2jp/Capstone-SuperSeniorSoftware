<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="EventInformation.aspx.cs" Inherits="Lab1.EventInformation" %>
                                    ...
                                    <center>
                                        ...
                                        <asp:GridView ID="grdEvents" HeaderStyle-BackColor="SteelBlue" HeaderStyle-ForeColor="White" runat="server" AutoGenerateColumns="false" OnRowCommand="grdEvents_RowCommand" HorizontalAlign="Center" Width="1123px">  
                                            <Columns>  
                                                ...
                                                <asp:TemplateField>  
                                                    <ItemTemplate>  
                                                        <asp:Button CssClass="form-control btn btn-primary btn-block"  ID="btnView" runat="server" Width="100" Text="View" PostBackUrl="~/EventDetails.aspx" CommandName="RegisterButton" />  
                                                    </ItemTemplate>  
                                                </asp:TemplateField>  
                                            </Columns>  
                                        </asp:GridView>  
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnBackToDashboard" CssClass="btn btn-success btn-block btn-lg" runat="server" PostBackUrl="~/TeacherDashboard.aspx" Width="400" Text="Back to Dashboard" />
                                    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="ClassRoster.aspx.cs" Inherits="Lab1.ClassRoster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
            <div class="col">
                <center>
                    <asp:Label ID="lblHeader" Font-Size="X-Large" Font-Bold="true" runat="server" Text=""></asp:Label>
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <div>      
                            <asp:GridView ID="grdClassRoster" runat="server" AutoGenerateColumns="False" CellPadding="6"
                                 OnRowCancelingEdit="grdClassRoster_RowCancelingEdit" OnRowEditing="grdClassRoster_RowEditing"
                                 OnRowUpdating="grdClassRoster_RowUpdating" OnRowDeleting="grdClassRoster_RowDeleting" AllowSorting="true" AllowPaging="true"
                                 OnSorting="grdClassRoster_Sorting">  
                                <Columns>  
                                    <asp:TemplateField>  
                                        <ItemTemplate>  

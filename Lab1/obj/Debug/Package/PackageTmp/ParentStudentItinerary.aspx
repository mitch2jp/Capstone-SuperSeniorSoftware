<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="ParentStudentItinerary.aspx.cs" Inherits="Lab1.SelectEvents" %>
                                    ...
                                    <center>
                                        ...
                                        <asp:GridView ID="grdEvents" HeaderStyle-BackColor="SteelBlue" HeaderStyle-ForeColor="White" runat="server" AutoGenerateColumns="false" OnRowCommand="grdEvents_RowCommand" HorizontalAlign="Center" Width="1123px">  
                                            <Columns>  
                                                ...
                                                <asp:TemplateField>  
                                                    <ItemTemplate>  
                                                        <asp:Button CssClass="form-control btn btn-primary btn-block"  ID="btnRegister" runat="server" PostBackUrl="~/ParentEventDetails.aspx" Width="100" Text="Register" CommandName="RegisterButton" />  
                                                    </ItemTemplate>  
                                                </asp:TemplateField>  
                                            </Columns>  
                                        </asp:GridView>  
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnFinish" CssClass="btn btn-success btn-block btn-lg" runat="server" PostBackUrl="~/ParentStudentRegistrationConfirmation.aspx" Width="400" Text="Finish" />
                                    </div>
                                    <div class="form-group">

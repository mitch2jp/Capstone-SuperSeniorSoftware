<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="StudentItinerary.aspx.cs" Inherits="Lab1.StudentEventInformation" %>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col mx-auto" style="width:auto">
                    <center>
                    <asp:Button ID="btnBack" CssClass="btn btn-info btn-block btn-md" Width="250" runat="server" PostBackUrl="~/StudentDashboard.aspx" Text="Back to Dashboard " />
                    </center>
                </div>
            </div>
            <br />

...
namespace Lab1
{
    public partial class TeacherSelectEvents : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT EventID, EventName, Date, Time, Building, Room, EventDescription FROM Event;", sqlCon);

<%@ Page Title="Jake Mitchell - Learning Seminar Page" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="Learning Seminar Information Page.aspx.cs" Inherits="Lab3.Learning_Seminar_Information_Page" %>
<%--Jake Mitchell
Section 0002
10/3/2020--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:Table runat="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="pageInstructions" runat="server" Text="Current (live) list of students attending the 'Learning Seminar' event: "></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
    ...
    <asp:Table runat ="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="lblVolunteerList" runat="server" Text="Current (live) list of volunteers attending the 'Learning Seminar' event: "></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    ...
    <asp:Table runat ="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="lblCoordinatorList" runat="server" Text="Current (live) list of  'Learning Seminar' event coordinators: "></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
